...
const startServer = async () => {
  try {
    ...
    // ⚠️ الشيما هلق مُدارة بـ migrations حقيقية (backend/migrations) - مو
    // sequelize.sync() بعد اليوم. أي تعديل على شكل الجداول لازم يصير عبر
    // `npm run migration:generate -- --name my_change` بدل تعديل الموديل بس.
